	...
	* Номенклатура 
		...
		* Создаем новый элемент
			...
			Если '$$ЭтоУХ$$' Тогда			
				...
				И из выпадающего списка с именем 'Родитель' я выбираю по строке 'Материлалы'
...
Сценарий: 01.03 Создание БС Организации
	...
	* Создание элемента
		Если '$$ЭтоУХ$$' Тогда
			...
			И из выпадающего списка с именем "Банк" я выбираю по строке '567567567'
