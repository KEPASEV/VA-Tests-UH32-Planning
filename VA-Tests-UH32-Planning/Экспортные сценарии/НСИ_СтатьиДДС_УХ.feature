...
Сценарий: Я для статьи ДДС с именем 'TheName' определяю группу раскрытия 'TheAnalyticsGroup'
	...
	* Находим и заполняем элемент
		...
		Иначе 
			...
			И из выпадающего списка с именем "ГруппаРаскрытия" я выбираю точное значение '[TheAnalyticsGroup]'	
...
Сценарий: Я для статьи ДДС с 'TheName' определяю виды аналитики 'TheAnalytics1', 'TheAnalytics2', 'TheAnalytics3', 'TheAnalytics4', 'TheAnalytics5', 'TheAnalytics6'
