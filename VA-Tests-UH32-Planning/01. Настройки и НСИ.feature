...
Сценарий: 01.06 Виды аналитик (корпоративные)
	* Создаем аналитику с произвольным классификатором
		...
		И Я создаю субконто УХ с именем 'Автотранспорт' и видом аналитики с кодом 'ВА1ОбъектР'
		И Я создаю субконто УХ с именем 'Здания' и видом аналитики с кодом 'ВА1ОбъектР'
		И Я создаю субконто УХ с именем 'Прочее' и видом аналитики с кодом 'ВА1ОбъектР'
...
Сценарий: 01.08 Статьи БДДС
	...
	* Для новых статей определяем тип движения "Приход/Расход"
		...
		И Я для статьи ДДС с именем 'ВА - Статья 4' определяю тип движения статьи 'Только приход'
	...
	* Назначаем контрольные аналитики
		И Я для статьи ДДС с именем 'ВА - Статья 1' устанавливаю контрольные аналитики по виду аналитики 'ВА - Объект расчетов', '', '', '', '', ''
		И Я для статьи ДДС с именем 'ВА - Статья 2' устанавливаю контрольные аналитики по виду аналитики 'Контрагенты', 'Номенклатурные группы', '', '', '', ''
		И Я для статьи ДДС с именем 'ВА - Статья 3' устанавливаю контрольные аналитики по виду аналитики 'Места поставки', '', '', '', ''
...
Сценарий: 01.09 Статьи БДР
	...
	* Для новых статей определяем тип движения "Доход/Расход"
		И Я для статьи ДиР с именем 'ВА - Статья 1' определяю тип движения статьи 'Только расход'
		...
		И Я для статьи ДиР с именем 'ВА - Статья 4' определяю тип движения статьи 'Только доход'
	...
	* Назначаем контрольные аналитики
		И Я для статьи ДиР с именем 'ВА - Статья 1' устанавливаю контрольные аналитики по виду аналитики 'ВА - Объект расчетов', '', '', '', '', ''
		И Я для статьи ДиР с именем 'ВА - Статья 2' устанавливаю контрольные аналитики по виду аналитики 'Контрагенты', 'Номенклатурные группы', '', '', '', ''
		И Я для статьи ДиР с именем 'ВА - Статья 3' устанавливаю контрольные аналитики по виду аналитики 'Места поставки', '', '', '', ''
