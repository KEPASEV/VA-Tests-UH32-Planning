...
Сценарий: 01.07 Группы аналитик статей
	* Создаем группы раскрытия с разным набором аналитик
		...
		и Я создаю группу аналитики статей 'ВА - Контрагенты-Номенклатура' с видами аналитик 'Контрагенты', 'Номенклатурные группы', '', '', '', ''
...
Сценарий: 01.12 Контрагенты
	...
	И Я для контрагента с именем 'ВА - Поставщик1' указываю ИНН '7714774531' и КПП '771401001' 
