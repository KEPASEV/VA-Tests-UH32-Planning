...
Сценарий: 01.02 Создание НСИ
	...
	* Группа аналитик статей
		и Я создаю группу аналитики статей 'Тест на 2 аналитик' с видами аналитик 'Контрагенты', 'Номенклатурные группы', '', '', '', ''
	...
	* Статья ДДС
		...
		И Я создаю группу статей ДДС с именем 'удалить'
		И Я создаю статью ДДС с именем 'Статья 1' родителем 'Тестовая группа'
		И Я создаю статью ДДС с именем 'тест' родителем 'удалить'
