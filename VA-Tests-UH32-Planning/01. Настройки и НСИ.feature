...
Сценарий: 01.01 Настройка информационной базы
	...
	* Настройка прав доступа
		Если '$$ЭтоЕРПУХ$$' Тогда
			...
			Когда открылось окно 'Отражение фактических данных 0000-000003 от *'
			И я перехожу к закладке с именем "СтраницаВзаиморасчеты"
			И в таблице "Взаиморасчеты" я активизирую поле с именем "ВзаиморасчетыСтатьяБюджета"
			И в таблице "Взаиморасчеты" я выбираю текущую строку
			...
			Тогда открылось окно 'Отражение фактических данных 0000-000003 от *'
			И в таблице "Взаиморасчеты" из выпадающего списка с именем "ВзаиморасчетыСтатьяБюджета" я выбираю точное значение 'Статья движения ден. средств'
			...
			И в таблице "" я выбираю текущую строку
			Тогда открылось окно 'Отражение фактических данных 0000-000003 от * *'
			И в таблице "Взаиморасчеты" из выпадающего списка с именем "ВзаиморасчетыСтатьяБюджета" я выбираю точное значение 'Статья доходов и расходов'
			Тогда открылось окно 'Статьи доходов и расходов'
			И в таблице  "Список" я перехожу на один уровень вниз
			И Я закрываю окно 'Статьи доходов и расходов'
			Тогда открылось окно 'Отражение фактических данных 0000-000003 от * *'
			И в таблице "Взаиморасчеты" в поле с именем 'ВзаиморасчетыСтатьяБюджета' я ввожу текст ''
			...
			Тогда открылось окно 'ВА - Статья * (Статья доходов и расходов)'
			И я меняю значение переключателя с именем 'ПриходРасход' на 'Доход или расход'
			И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
			И я жду закрытия окна 'ВА - Статья * (Статья доходов и расходов) *' в течение 20 секунд
...
Сценарий: 01.12 Контрагенты
	...
	ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда	
		И Я создаю партнера с именем 'ВА - Поставщик' тип 'Поставщик' в 1C:ERPУХ
		И Для партнера 'ВА - Поставщик' я создаю контрагента с именем 'ВА - Поставщик1' вид 'Юридическое лицо' в 1C:ERPУХ
...
Сценарий: 01.13 Номенклатура
	Если '$$ЭтоУХ$$' Тогда
		...
		И Я создаю тип цен номенклатуры с именем 'ВА - Цена1'
	ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
