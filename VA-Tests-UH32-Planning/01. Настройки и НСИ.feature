...
//			И я устанавливаю флаг с именем 'ВестиУчетПоОрганизациям'
	...
	* Задаем настройки для Корпоративных закупок
		...
		Если '$$ЭтоУХ$$' Тогда
			...
			И из выпадающего списка с именем "ТипЦенДляРасценкиЗаявокНаПотребность" я выбираю точное значение 'ВА - Цена1'
	
		Если '$$ЭтоЕРПУХ$$' Тогда
			И из выпадающего списка с именем "ТипЦенДляРасценкиЗаявокНаПотребность" я выбираю точное значение 'Оптовая'
